...
IBM_USERNAME = "differlong@gmail.com" # IBM Speech to Text usernames are strings of the form XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX
IBM_PASSWORD = "miracle2016" # IBM Speech to Text passwords are mixed-case alphanumeric strings
try:
